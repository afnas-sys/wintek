...
class CrashBalanceContainer extends ConsumerStatefulWidget {
  const CrashBalanceContainer({super.key});

  @override
  ConsumerState<CrashBalanceContainer> createState() =>
      _CrashBalanceContainerState();
}

class _CrashBalanceContainerState extends ConsumerState<CrashBalanceContainer> {
  @override
  void initState() {
    super.initState();
